...
A comparative user experience evaluation was done between the old and new tool to find out how usability was improved. It was found that...
...
Vanhan ja uuden ClusterWebin välillä tehtiin vertaileva käyttökokemuksen evaluointi jolla pyritttiin selvittämään millä tavoin käytettävyys parantui. Tuloksista nähdään että...
...
\chapter{Re-engineered Cluster Web}\label{cluweb_chapter}
\input{cluweb}  % ./cluweb.tex
