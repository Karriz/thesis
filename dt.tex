...
% TODO:
% Cluster Web architecture diagram DONE
% Cluster Web issues in a table DONE
% Research questions in Introduction DONE
% Evaluation background in its own section DONE
% Show standard deviations of UEQ
% More discussion
% Contribution in context DONE
% OpenMCT comparison DONE
