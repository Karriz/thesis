...
Other tools are also being integrated to the mission control systems, such as BOSS Dashboard. It provides a modern web-based interface for browsing and visualizing telemetry data. \cite{boss} Together with OpsWeb, BOSS Dashboard could be displayed on a big screen in mission control room to allow spacecraft controllers to overview the mission status easily.