...
The effect of participants' self-reported experience level (table \ref{experience_levels}) on the UEQ results was also evaluated. Participants who answered 4 or more were considered to be experienced, while 4 or less were considered inexperienced. Because only one participant reported to be inexperienced with Cluster Web, the results could not be statistically compared. That participant responded to Cluster Web more positively than the average, in particular on the scales "perspiquity" and "efficiency", which were above the error bars.

With OpsWeb, the comparison of UEQ results between inexperienced and experienced users did not show any kind of a trend or statistically significant difference.
